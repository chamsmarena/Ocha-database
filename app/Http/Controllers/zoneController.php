...
class zoneController extends Controller
{
    ...
    public function show_view_filterV2($category,$items,$periodFrom,$periodTo,$adminLevel)
    {
        ...
        return view('zone.filterV3',['datas'=>$dataByZone,"category"=>$category,"items"=>$items,"adminLevel"=>$adminLevel,"periodFrom"=>$periodFrom,"periodTo"=>$periodTo,"countriesList"=>$countriesList]);
    }
