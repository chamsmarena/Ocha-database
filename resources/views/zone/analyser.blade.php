                        ...
                        <?php
                            ...
                            foreach ($liste_localites as $localite){ 
                                ...
                                foreach ($keyfigure_displacements as $keyfigure_displacement){
                                    if($keyfigure_displacement->local_name == $localite->local_name){
                        ...
                        <?php
                            ...
                            foreach ($liste_localites as $localite){ 
                                ...
                                foreach ($keyfigure_cadre_harmonises_current as $ch_data){
                                    if($ch_data->local_name == $localite->local_name){
                        ...
                        <?php
                            ...
                            foreach ($liste_localites as $localite){ 
                                ...
                                foreach ($keyfigure_caseloads as $caseload){
                                    if($caseload->local_name == $localite->local_name){
                        ...
                        <?php
                            foreach ($liste_localites as $localite){ 
                                ...
                                foreach ($keyfigure_nutritions as $nutrition){
                                    if($nutrition->local_name == $localite->local_name){
